...
// vehicleDetailsRoutes.js
const express = require('express');
const router = express.Router();
const vehicleDetailsController = require('../../controllers/MasterControllers/vehicleDetailsController');

router.post('/', vehicleDetailsController.createVehicleDetails);
router.get('/', vehicleDetailsController.getAllVehicleDetails);
router.get('/:vehicle_No', vehicleDetailsController.getVehicleDetailsByNumber);
router.patch('/:vehicle_No', vehicleDetailsController.updateVehicleDetailsByNumber);
router.delete('/:vehicle_No', vehicleDetailsController.deleteVehicleDetailsByNumber);
